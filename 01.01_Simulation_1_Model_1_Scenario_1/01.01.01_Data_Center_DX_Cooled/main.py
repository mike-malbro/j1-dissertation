...
def generate_data_center_dx_cooled_model():
    ...
    asset_path = Path(__file__).parent / ".." / ".." / "downloads" / "01.01.01_asset.png"
    ...
    module_text = "Module: 01.01.01 - Data Center DX Cooled Model"
    ax.text(0.1, 0.1, module_text, fontsize=10, fontweight='normal',
            ha='left', va='center', fontfamily='Arial', color='gray')
    
    # Save as PDF
    output_file = output_dir / f"data_center_dx_cooled_01.01.01_{timestamp}.pdf"
