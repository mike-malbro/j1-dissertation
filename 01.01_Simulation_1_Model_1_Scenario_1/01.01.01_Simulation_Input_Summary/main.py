#!/usr/bin/env python3
"""
Module 01.01.01 - Simulation Input Summary
...
Simulation input parameters and configuration summary.
"""
...
def generate_simulation_input_summary():
    ...
    # Subtitle
    subtitle_text = "Model_1_Scenario_1 Configuration Parameters"
    ...
    crac_specs = [
        ...
        "• Control Strategy: Rule-based load allocation",
        "• Performance Curves: Individual unit optimization"
    ]
    ...
    sim_params = [
        "• Analysis Type: Steady-state performance",
        "• Time Period: Annual analysis",
        "• Load Distribution: Dynamic allocation",
        "• Optimization Target: Energy efficiency",
        "• Baseline Comparison: Conventional controls",
        "• Expected Improvement: 15% energy efficiency"
    ]
    ...
    ax.text(4.25, 0.5, "10", fontsize=14, fontweight='normal',
    ...
    module_text = "Module: 01.01.01 - Simulation Input Summary"
    ax.text(0.1, 0.1, module_text, fontsize=10, fontweight='normal',
            ha='left', va='center', fontfamily='Arial', color='gray')
    
    # Save as PDF
    output_file = output_dir / f"simulation_input_summary_01.01.01_{timestamp}.pdf"
