...
J1 Data Center Room Volume with Google Drawing integration.
"""
...
def generate_data_center_room_volume():
    """Generate J1 Data Center Room Volume page with integrated Google Drawing"""
    ...
    # Google Drawing link
    drawing_link = "https://docs.google.com/drawings/d/1ZgghbDOSyghwulohx7NoQ19p9pPdS2nZlsCwmFUxMHA/edit"
    ...
    if asset_path.exists():
        try:
            ...
            ax.text(0.1, y_pos - 0.8, "Figure 1.2.01", fontsize=14, fontweight='bold',
                    ha='left', va='center', fontfamily='Arial', color='black')
            
            # Small one-sentence description with book spacing
            ax.text(0.1, y_pos - 1.2, "Data center room volume analysis for Harrisburg facility.", 
            ...
            ax.text(0.1, 6, "J1 Data Center Room Volume Image", fontsize=14, fontweight='bold',
    ...
    module_text = "Module: 01.02.01 - J1 Data Center Room Volume"
    ax.text(0.1, 0.1, module_text, fontsize=10, fontweight='normal',
            ha='left', va='center', fontfamily='Arial', color='gray')
    
    # Save as PDF
    output_file = output_dir / f"data_center_room_volume_01.02.01_{timestamp}.pdf"
    with PdfPages(output_file) as pdf:
        pdf.savefig(fig, dpi=300)
    
    plt.close()
    
    print(f"✅ J1 Data Center Room Volume generated: {output_file}")
    return str(output_file)

def main():
    """Main function to generate J1 Data Center Room Volume"""
    print("🎨 Generating J1 Data Center Room Volume...")
    
    try:
        output_file = generate_data_center_room_volume()
        print(f"📄 J1 Data Center Room Volume created successfully: {output_file}")
        return True
    except Exception as e:
        print(f"❌ Error generating J1 Data Center Room Volume: {e}")
        return False
