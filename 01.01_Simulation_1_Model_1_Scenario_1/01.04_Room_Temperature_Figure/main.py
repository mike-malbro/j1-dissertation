#!/usr/bin/env python3
"""
Module 01.04 - Room Temperature Versus Timestep Figure
    ...
    try:
        ...
        if fresh_csv_path:
            ...
            if not csv_path.exists():
                # Final fallback to 01.03 output
                csv_path = Path(__file__).parent / ".." / "01.03_Simulation_Data_CSV" / "output" / "simulation_data.csv"
...
def create_room_temperature_figure(df):
    ...
    output_file = output_dir / f"room_temperature_figure_01.04_{timestamp}.pdf"
    ...
    with PdfPages(output_file) as pdf:
        ...
        module_text = "Module: 01.04 - Room Temperature Analysis"
        ...
        # Page number - centered like 01.0B
        ax.text(4.25, 0.5, "13", fontsize=14, fontweight='normal',
                ha='center', va='center', fontfamily='Arial', color='black')
        ...
        # Page number - centered like 01.0B
        ax.text(4.25, 0.5, "14", fontsize=14, fontweight='normal',
                ha='center', va='center', fontfamily='Arial', color='black')
